...
@section('content')
    ...
    <section class="main pt-5">
        ...
        <h1 class="large text-heading mt-5">
            Sign Up
        </h1>
        ...
        <form action="{{'/register/create'}}" class="form" method="post" autocomplete="off">
            ...
            <div class="form-group inputWithIcon">
                <select id="cFor" name="cFor" required>
                    ...
                    <option class="others" value=1>Volunteer</option>
                    <option class="others" value=2>Core Member</option>
                    <option class="others" value=3>Observer</option>
                </select>
            ...
            <div class="form-group inputWithIcon">
                ...
                <i id="nm_ok" class="fas fa-check-circle text-green" hidden=""></i>
                <i id="nm_not_ok" class="fas fa-times-circle text-red" hidden></i>
